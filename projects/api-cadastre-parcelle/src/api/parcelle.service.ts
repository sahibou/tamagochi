...
import { FeatureCollectionParcelle } from '../model/featureCollectionParcelle';
...
export class ParcelleService {
    ...
    /**
     * Recherche d&#x27;informations sur les parcelles cadastrales d&#x27;une commune
     ...
     * @param numero Numero de la parcelle sur 4 caractères
     * @param codeArr Code arrondissement pour Paris, Lyon, Marseille
     * @param comAbs Code commune absorbée
     ...
     * @param sourceIgn « PCI » pour la ressource Parcellaire Express ou « BDP » pour la ressource BD Parcellaire
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getParcelle(codeInsee?: any, section?: any, numero?: any, codeArr?: any, comAbs?: any, geom?: Geometry, limit?: any, start?: any, sourceIgn?: any, observe?: 'body', reportProgress?: boolean): Observable<FeatureCollectionParcelle>;
    public getParcelle(codeInsee?: any, section?: any, numero?: any, codeArr?: any, comAbs?: any, geom?: Geometry, limit?: any, start?: any, sourceIgn?: any, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<FeatureCollectionParcelle>>;
    public getParcelle(codeInsee?: any, section?: any, numero?: any, codeArr?: any, comAbs?: any, geom?: Geometry, limit?: any, start?: any, sourceIgn?: any, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<FeatureCollectionParcelle>>;
    public getParcelle(codeInsee?: any, section?: any, numero?: any, codeArr?: any, comAbs?: any, geom?: Geometry, limit?: any, start?: any, sourceIgn?: any, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (comAbs !== undefined && comAbs !== null) {
        ...
        if (sourceIgn !== undefined && sourceIgn !== null) {
            queryParameters = queryParameters.set('source_ign', <any>sourceIgn);
        }
        ...
        return this.httpClient.request<FeatureCollectionParcelle>('get',`${this.basePath}/api/cadastre/parcelle`,
            {
